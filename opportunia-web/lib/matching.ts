...
const SKILL_PROXIMITY: Record<string, string[]> = {
  ...
  agronomie: ['agriculture', 'agroecologie', 'agroforesterie', 'sciences du sol', 'pedologie', 'environnement', 'developpement rural'],
  agriculture: ['agronomie', 'agroecologie', 'agroforesterie', 'production vegetale', 'elevage', 'developpement rural'],
  environnement: ['ecologie', 'developpement durable', 'sciences environnementales', 'gestion des dechets', 'rse', 'changement climatique', 'agroforesterie'],
